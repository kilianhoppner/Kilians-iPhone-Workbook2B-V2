    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "Good day!<p></p>Use the <strong>arrow keys</strong> on your keyboard to navigate. Click below to start." + fullScreenText + "<p></p>";
        ...
        function createGameEndElement(message, elmId, elmClassName) {
            ...
            gameEndTxt.innerHTML = "Game Over :(<p></p>" + message  + "<p></p>";
        ...
        function createTryAgainElement() {
            return createGameEndElement("<em>In the gentle light of dawn, hope softly whispers, offering second chances anew.</em>", "sbTryAgain", "snake-try-again-dialog");
        }
